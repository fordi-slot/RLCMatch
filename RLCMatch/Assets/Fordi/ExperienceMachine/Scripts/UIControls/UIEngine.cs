...
namespace Fordi.UI
{
    ...
    public interface IUIEngine
    {
        ...
        void DisplayMessage(MessageArgs args);
        void ConfirmationPopup(PopupInfo args);
    ...
    public class UIEngine : MonoBehaviour, IUIEngine
    {
        ...
        public void OpenSignupPage(MenuArgs args)
        {
            m_standaloneInterface.OpenSignupPage(args);
            m_vrInterface?.OpenSignupPage(args);
        }
